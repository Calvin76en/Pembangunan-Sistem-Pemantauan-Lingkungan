                ...
                <tr>
                  ...
                  <td class="px-6 py-3 whitespace-nowrap">
                    <div class="flex items-center gap-2">
                      ...
                      <!-- Jika keterangan Completed, tampilkan tombol Edit -->
                      <a href="{{ route('edit.oilfuel', ['location_id' => $location->location_id]) }}"
                        class="bg-warning-500 hover:bg-warning-600 px-4 py-2.5 text-sm text-white rounded-lg font-medium">
                        Edit
                      </a>
                      @else
                      <!-- Jika keterangan kosong, tampilkan tombol Add Data -->
