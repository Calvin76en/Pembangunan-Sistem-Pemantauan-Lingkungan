...
<main>
  <div class="mx-auto max-w-7xl p-6">
    <!-- Breadcrumb -->
    <div x-data="{ pageName: `Lokasi Oil Trap & Fuel Trap`}">
    ...
    <!-- Header Card -->
    <!-- <div class="rounded-2xl p-8 mb-8 shadow-xl" style="background: rgba(34, 197, 94, 1);">
      <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
        <div>
          <h1 class="text-3xl font-bold text-white mb-2">Monitoring Oil Trap & Fuel Trap</h1>
          <p class="text-white/80">Kelola data pemantauan oil trap & fuel trap untuk setiap lokasi monitoring</p>
        </div>
      ...
      <div class="px-8 py-6 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            ...
            <p class="text-gray-600 dark:text-gray-400">Total {{ count($lokasi_monitoring_oilfuel) }} lokasi</p>
          </div>

          <!-- Date Picker -->
          <form method="GET" action="{{ route('lokasi-oilfuel') }}" class="flex items-center">
            <div class="relative">
      ...
      <div class="overflow-x-auto">
        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
          ...
          <tbody class="bg-white dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-700">
            @foreach($lokasi_monitoring_oilfuel as $index => $location)
            @php
            ...
            <tr class="hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors duration-200">
              ...
              <td class="px-8 py-6 text-center">
                ...
                <a href="{{ route('edit.oilfuel', ['location_id' => $location->location_id]) }}?date={{ $selectedDate }}"
      ...
      <div class="px-8 py-6 bg-gray-50 dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div class="flex items-center text-sm text-gray-600 dark:text-gray-400">
            ...
            Total {{ count($lokasi_monitoring_oilfuel) }} lokasi monitoring
          </div>
...
<script>
  document.addEventListener("DOMContentLoaded", function() {
    flatpickr("#datetimePicker", {
      enableTime: false,
      dateFormat: "Y-m-d",
      defaultDate: "{{ $selectedDate ?? \Carbon\Carbon::now()->toDateString() }}",
