...
<main>
  <div class="mx-auto max-w-7xl p-6">
    <!-- Breadcrumb -->
    <div x-data="{ pageName: `Lokasi Curah Hujan`}">
    ...
    <!-- Header Card -->
    <!-- <div class="rounded-2xl p-8 mb-8 shadow-xl" style="background: rgba(59, 130, 246, 1);">
      <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
        <div>
          <h1 class="text-3xl font-bold text-white mb-2">Monitoring Curah Hujan</h1>
          <p class="text-white/80">Kelola data pemantauan curah hujan untuk setiap lokasi monitoring</p>
        </div>
      ...
      <div class="px-8 py-6 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            ...
            <p class="text-gray-600 dark:text-gray-400">Total {{ count($lokasi_monitoring_curah_hujan) }} lokasi </p>
          </div>

          <!-- Date Picker -->
          <form method="GET" action="{{ route('lokasi-curah') }}" class="flex items-center">
            <div class="relative">
      ...
      <div class="overflow-x-auto">
        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
          ...
          <tbody class="bg-white dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-700">
            @foreach($lokasi_monitoring_curah_hujan as $index => $location)
            @php
      ...
      <div class="px-8 py-6 bg-gray-50 dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div class="flex items-center text-sm text-gray-600 dark:text-gray-400">
            ...
            Total {{ count($lokasi_monitoring_curah_hujan) }} lokasi monitoring
          </div>
