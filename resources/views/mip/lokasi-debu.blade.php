      ...
      <div class="px-8 py-6 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            ...
            <p class="text-gray-600 dark:text-gray-400">Total {{ count($lokasi_monitoring_debu) }} lokasi </p>
          </div>

          <!-- Date Picker -->
          <form method="GET" action="{{ route('mip-lokasi-debu') }}" class="flex items-center">
            <div class="relative">
      ...
      <div class="overflow-x-auto">
        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
          ...
          <tbody class="bg-white dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-700">
            @foreach($lokasi_monitoring_debu as $index => $location)
            @php
      ...
      <div class="px-8 py-6 bg-gray-50 dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div class="flex items-center text-sm text-gray-600 dark:text-gray-400">
            ...
            Total {{ count($lokasi_monitoring_debu) }} lokasi monitoring
          </div>
