      ...
      <div
        ...
        <div class="overflow-hidden rounded-2xl border border-gray-200 bg-white pt-4 dark:border-gray-800 dark:bg-white/[0.03]">
          <div class="flex flex-col gap-5 px-6 mb-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <form method="GET" action="{{ route('mip-lokasi-debu') }}" class="mb-4">
              <input
                id="datetimePicker"
                name="date"
                type="text"
                ...
                <tr>
                  ...
                  <td class="px-6 py-3 whitespace-nowrap">
                    <div class="flex items-center">
                      ...
                      'draft' => 'bg-warning-50 text-warning-600 dark:bg-warning-500/15 dark:text-warning-500',
                      default => 'bg-gray-100 text-gray-400',
                      };
                      @endphp
                      <p class="{{ $statusClass }} text-theme-xs rounded-full px-2 py-0.5 font-medium">
                        {{ ucfirst($status) }}
                      </p>
                    </div>
                  </td>
