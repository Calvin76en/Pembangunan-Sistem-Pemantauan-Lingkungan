      ...
      <div class="border-t border-gray-100 p-5 dark:border-gray-800 sm:p-6">
        ...
        <div class="overflow-hidden rounded-2xl border border-gray-200 bg-white pt-4 dark:border-gray-800 dark:bg-white/[0.03]">
          <div class="flex flex-col gap-5 px-6 mb-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <!-- Filter Tanggal -->
            <form method="GET" action="{{ route('lokasi-oilfuel') }}" class="mb-6 sm:mb-0">
              <input
                id="datetimePicker"
                name="date"
                type="text"
          ...
          <div class="max-w-full overflow-x-auto custom-scrollbar">
            <table class="min-w-full">
              ...
              <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                ...
                @php
                $record = $dataByDate->get($location->location_id);
                $status = $record ? 'completed' : 'empty';
                @endphp
                <tr>
                  ...
                  <td class="px-6 py-3 whitespace-nowrap">
                    <div class="flex items-center">
                      <p class="@if($status === 'completed') bg-success-50 text-success-600
                  ...
                  <td class="px-6 py-3 whitespace-nowrap">
                    <div class="flex items-center gap-2">
                      @if ($status === 'completed') {{-- Jika data sudah ada --}}
