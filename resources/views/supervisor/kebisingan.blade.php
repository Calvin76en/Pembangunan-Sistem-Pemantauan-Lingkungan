        ...
        <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
          ...
          <div class="p-5 space-y-6 border-t border-gray-100 dark:border-gray-800 sm:p-6">
            <form method="POST" action="{{ route('store.kebisingan') }}">
              ...
              <!-- Hidden lokasi dan monitoring_id -->
              ...
              <div id="form-container" class="space-y-4 max-h-[500px] overflow-y-auto border border-gray-200 dark:border-gray-700 rounded-md p-3">
                <!-- Baris form input pertama -->
                <div class="flex items-center gap-4">
                  <label class="w-20 font-semibold text-center text-gray-700 dark:text-white/80" for="spl-1">L1</label>
                  <input
                    id="spl-1"
                    type="number"
                    step="0.1"
                    min="0"
                    name="spl[1]"
                    class="flex-1 rounded border border-gray-300 px-3 py-2 dark:border-gray-600 dark:bg-gray-900 dark:text-white"
              ...
              <div class="mt-6">
                <button
                  type="submit"
                  class="flex items-center justify-center w-full gap-2 rounded-lg bg-brand-500 p-3 text-sm font-medium text-white transition-colors hover:bg-brand-600">
                  Simpan Data
                  <svg
                    class="fill-current"
                    width="20"
...
<!-- Script untuk tambah baris input -->
<script>
  document.addEventListener('DOMContentLoaded', function() {
    ...
    addRowBtn.addEventListener('click', function() {
      ...
      if (currentRows < maxRows) {
        ...
        newRow.innerHTML = `
          <label for="spl-${nextIndex}" class="w-20 font-semibold text-center text-gray-700 dark:text-white/80">L${nextIndex}</label>
          <input
            id="spl-${nextIndex}"
            type="number"
            step="0.1"
