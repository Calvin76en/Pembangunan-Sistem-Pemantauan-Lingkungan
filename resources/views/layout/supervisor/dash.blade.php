    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside
            ...
            <div
                ...
                <a href="{{ route('supervisor.dashboard') }}" class="flex flex-col items-center">
                ...
                <nav x-data="{selected: $persist('Dashboard')}">
                    ...
                    <div>
                        ...
                        <ul class="mb-6 flex flex-col gap-4">
                            ...
                            <li>
                                <a
                                    href="{{ route('supervisor.approval.daily') }}"
                                    class="menu-item group"
                                    :class="(page === 'approval-daily') ? 'menu-item-active' : 'menu-item-inactive'">
                                    <svg
                                        :class="(page === 'approval-daily') ? 'menu-item-icon-active' : 'menu-item-icon-inactive'"
                                        width="24"
                                        height="24"
                                        viewBox="0 0 24 24"
                                        fill="none"
                                        ...
                                        <path
                                            d="M3 5a2 2 0 0 1 2-2h9l4 4v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5z"
                                            stroke="currentColor"
                                            stroke-width="1.5"
                                            stroke-linecap="round"
                                            stroke-linejoin="round"
                            ...
                            <li>
                                <a
                                    href="{{ route('supervisor.approval.monthly') }}"
                                    class="menu-item group"
                                    :class="(page === 'approval-monthly') ? 'menu-item-active' : 'menu-item-inactive'">
                                    <svg
                                        :class="(page === 'approval-monthly') ? 'menu-item-icon-active' : 'menu-item-icon-inactive'"
                                        width="24"
                                        height="24"
                                        viewBox="0 0 24 24"
                                        fill="none"
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            flatpickr("#datetimePicker", {
                enableTime: false, // non‐aktifkan pilihan jam
                noCalendar: false, // tetap tampil kalender
                dateFormat: "d M Y", // format hanya tanggal
                // jika ingin tampilan lebih user‐friendly, bisa pakai:
                // altInput: true,
                // altFormat: "F j, Y",
            });
